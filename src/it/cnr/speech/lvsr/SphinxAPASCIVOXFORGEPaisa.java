...
public class SphinxAPASCIVOXFORGEPaisa extends SphinxVFPaisa{
	...
	public String recognize(File wave) {
		...
		if (!(transcrFile.exists() && cache)) {
			String javaExecution = "java -cp "+sphinxASRLocation+" edu.cmu.sphinx.demo.transcriber.SphinxRecognizerForCommandLine \""+wave.getAbsolutePath()+"\" \"it-IT\" 36";
	...
	public static void main(String[] args) {
		...
		SphinxAPASCIVOXFORGEPaisa s = new SphinxAPASCIVOXFORGEPaisa();
